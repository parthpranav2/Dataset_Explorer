				...
				<xs:complexType>
					<xs:sequence>
						...
						<xs:element name="AddressLongitude" minOccurs="0">
							<xs:annotation>
								<xs:documentation>Longitude of delivery address</xs:documentation>
							</xs:annotation>
							<xs:complexType mixed="true">
								<xs:attribute name="Type">
									<xs:annotation>
						...
						<xs:element name="AddressLongitudeDirection" minOccurs="0">
							<xs:annotation>
								<xs:documentation>Longitude direction of delivery address;N=North and S=South</xs:documentation>
							</xs:annotation>
							<xs:complexType mixed="true">
								<xs:attribute name="Type">
									<xs:annotation>
